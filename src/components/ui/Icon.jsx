...
const P = {
  ...
  bean: (
    <>
      <ellipse cx="12" cy="12" rx="6" ry="8.4" />
      <path d="M12 4.8C8.8 8 15.2 11 12 14.2 10 16 11 18 12 19.2" />
    </>
  ),
  berry: (
    <>
      <circle cx="8.6" cy="16.4" r="3" />
      <circle cx="15.4" cy="16.4" r="3" />
      <path d="M8.6 13.4C9.4 9 13 6.5 16.4 6.2" />
      <path d="M15.4 13.4C15.6 10 16 7.6 16.4 6.2" />
      <path d="M16.4 6.2c1.4-1.6 3.8-1.6 5-.2-1 1.6-3.4 1.8-5 .2z" />
    </>
  ),
  basket: (
    <>
