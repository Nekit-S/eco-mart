...
const P = {
  ...
  heart: <path d="M12 20s-7-4.4-7-9.4A3.6 3.6 0 0 1 12 7a3.6 3.6 0 0 1 7-1.4c0 5-7 9.4-7 9.4z" />,
  ...
  store: (
    <>
      <path d="M4 9.5 5.5 4h13L20 9.5M4 9.5h16M4 9.5v10h16v-10M4 9.5a2.2 2.2 0 0 0 4 0 2.2 2.2 0 0 0 4 0 2.2 2.2 0 0 0 4 0 2.2 2.2 0 0 0 4 0" />
    </>
  ),
  cash: (
    <>
  ...
  croissant: (
    <>
      <path d="M4 16c3-1 5-3 6-6 1 3 3 5 6 6-2 1.5-4 2-6 2s-4-.5-6-2z" />
      <path d="M10 10c-1.5-1-3-1.3-4.5-1M14 10c1.5-1 3-1.3 4.5-1" />
    </>
  ),
  bread: (
    <>
